...
class ChargingSimulator:
    ...
    def connector_id_field(self):
        selector = (By.XPATH, "//input[@id='BrutusinForms#7_0']")
        return self.driver.find_element(*selector)

    def id_tag_field(self):
        selector = (By.XPATH, "//input[@id='BrutusinForms#7_1']")
        return self.driver.find_element(*selector)

    def meter_start_field(self):
        selector = (By.XPATH, "//input[@id='BrutusinForms#7_2']")
        return self.driver.find_element(*selector)

    def start_transaction_button(self):
        selector = (By.CSS_SELECTOR, "#submit-cp-StartTransaction")
        self.driver.find_element(*selector).click()

    def get_transaction_id(self):
        selector = (By.XPATH, '//*[@id="log"]/div[1]')
        result_list = []

        ResultStartTransaction = self.driver.find_elements(*selector)
    ...
    def id_tag_field_stop(self):
        selector = (By.XPATH, "//input[@id='BrutusinForms#9_0']")
        return self.driver.find_element(*selector)
    
    def meter_stop_field(self):
        selector = (By.XPATH, "//input[@id='BrutusinForms#9_1']")
        return self.driver.find_element(*selector)
    
    def transaction_id_field(self):
        selector = (By.XPATH, "//input[@id='BrutusinForms#9_3']")
        return self.driver.find_element(*selector)
    
    def timestamp_add_hour(self):
        timestamp_field = self.driver.find_element(By.XPATH, "//input[@id='BrutusinForms#9_2']")
    ...
    def reason_dropdown_evdisconnected(self):
        selector = (By.XPATH, "(//select[@id='BrutusinForms#9_4'])")
        dropdown = Select(self.driver.find_element(*selector))
        dropdown.select_by_visible_text("EVDisconnected")
    
    def stop_transaction_button(self):
        selector = (By.CSS_SELECTOR, "#submit-cp-StopTransaction")
        self.driver.find_element(*selector).click()
