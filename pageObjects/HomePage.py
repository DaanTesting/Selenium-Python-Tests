...
class HomePage:
    ...
    def menu_label_expenses(self):
        selectorOne = (By.CSS_SELECTOR, 'a[href*="mobility"]')
        selectorTwo = (By.CSS_SELECTOR, 'a[href*="expenses"]')
    ...
    def menu_label_profiles(self):
        selector = (By.XPATH, "//span[contains(normalize-space(),'Profiles')]")
        self.driver.find_element(*selector).click()
    ...
    def menu_label_whitelist(self):
        selector = (By.XPATH, "//span[.='Whitelist']")
        self.driver.find_element(*selector).click()
        whitelistpage = WhiteListPage(self.driver)
        return whitelistpage

    def menu_label_account(self):
        selector = (By.XPATH, "//span[.='Account']")
        self.driver.find_element(*selector).click()

    def menu_label_account_details(self):
        selector = (By.XPATH, "(//span[normalize-space()='Account details'])[1]")
        self.driver.find_element(*selector).click()
        accountdetailspage = AccountDetailsPage(self.driver)
        return accountdetailspage

    def menu_label_msp_invoices(self):
        selector = (By.XPATH, "(//span[normalize-space()='Invoices'])[1]")
        self.driver.find_element(*selector).click()

    def menu_label_payment_methods(self):
        selector = (By.XPATH, "(//span[normalize-space()='Payment methods'])[1]")
        self.driver.find_element(*selector).click()

    def menu_label_profiles_overview(self):
        selector = (By.XPATH, "(//span[normalize-space()='Overview'])[1]")
        self.driver.find_element(*selector).click()
        profilesoverview = HrProfilesOverview(self.driver)
        return profilesoverview

    def menu_label_import_export(self):
        selector = (By.XPATH, "(//span[normalize-space()='Import & Export'])[1]")
        self.driver.find_element(*selector).click()

    def menu_label_import(self):
        selector = (By.XPATH, "(//span[normalize-space()='Import'])[1]")
        self.driver.find_element(*selector).click()

    def menu_label_administration_hr(self):
        selector = (By.XPATH, "(//span[normalize-space()='Administration'])[1]")
        self.driver.find_element(*selector).click()

    def menu_label_create_report(self):
        selector = (By.XPATH, "(//span[normalize-space()='Create report'])[1]")
        self.driver.find_element(*selector).click()

    def menu_label_msp_tokens(self):
        selector = (By.XPATH, "(//span[normalize-space()='Tokens'])[2]")
        self.driver.find_element(*selector).click()

    def menu_label_msp_vouchers(self):
        selector = (By.XPATH, "(//span[normalize-space()='Vouchers'])[1]")
        self.driver.find_element(*selector).click()

    def menu_label_msp_contracts(self):
        selector = (By.XPATH, "(//span[normalize-space()='Contracts'])[2]")
        self.driver.find_element(*selector).click()

    def menu_label_msp_operators(self):
        selector = (By.XPATH, "(//span[normalize-space()='Operators'])[1]")
        self.driver.find_element(*selector).click()
    ...
    def menu_label_cpo_tokens(self):
        selector = (By.XPATH, "(//span[normalize-space()='Tokens'])[1]")
        self.driver.find_element(*selector).click()

    def menu_label_cpo_simcards(self):
        selector = (By.XPATH, "(//a[@href='/co/admin/simcards/'])[1]")
        self.driver.find_element(*selector).click()

    def menu_label_cpo_contracts(self):
        selector = (By.XPATH, "(//span[normalize-space()='Contracts'])[1]")
        self.driver.find_element(*selector).click()

    def menu_label_cpo_roaming(self):
        selector = (By.XPATH, "(//span[normalize-space()='Roaming'])[1]")
        self.driver.find_element(*selector).click()

    def menu_label_cpo_finance(self):
        selector = (By.XPATH, "(//span[normalize-space()='Finance'])[1]")
        self.driver.find_element(*selector).click()
    
    def menu_label_cpo_reports(self):
        selector = (By.XPATH, "(//span[normalize-space()='Reports'])[1]")
        self.driver.find_element(*selector).click()
