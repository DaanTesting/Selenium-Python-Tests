...
class TestOne(BaseClass):
    ...
    def test_tags_create_delete_expanded(self, setup, login_data):
        ...
        time.sleep(1)
        assert profilesoverview.driver.find_element(
    ...
    # self.driver.find_element(
    #     By.CSS_SELECTOR, "a[href='/sp/admin/customers/1300/']"
    # ).click()
    # self.driver.find_element(By.XPATH, "//span[contains(.,'Users')]").click()
    # self.driver.find_element(By.XPATH, "//a[.='Create user']").click()
    # self.driver.find_element(By.CSS_SELECTOR, "#id_form-0-first_name").send_keys(
    #     "Automatic"
    # )
    # self.driver.find_element(By.CSS_SELECTOR, "#id_form-0-last_name").send_keys(
    #     "Deleted"
    # )
