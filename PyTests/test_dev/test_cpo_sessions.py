...
@pytest.fixture(params=ChargingSessionData.roaming_staging_data)
...
class TestOne(BaseClass):
    ...
    def test_roaming_session__platform_verification(self, setup, login_data):
        ...
        self.driver.get("https://staging.optimile-dev.eu/")
        ...
        assert 132 <= sessionvalue_float <= 135, "Incorrect value."
...
class TestTwo(BaseClass):
    ...
    def test_whitelist_session__platform_verification(self, setup, login_data):
        ...
        cpocustomerpage.search_by_name_field().send_keys("Main Customer Autotesting" + "\n")
        log.info("Opening user.")
        cpoindividualcustomer = cpocustomerpage.click_on_top_result()
